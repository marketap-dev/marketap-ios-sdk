...
class MarketapClient: NSObject, MarketapClientProtocol, WKNavigationDelegate, WKScriptMessageHandler {
    ...
    init(projectId: String) {
        self.core = MarketapCore(config: MarketapConfig(projectId: projectId))
        super.init()
